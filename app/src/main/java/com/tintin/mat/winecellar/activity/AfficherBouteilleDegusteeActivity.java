...
public class AfficherBouteilleDegusteeActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        getMenuInflater().inflate(R.menu.afficher_bouteille_degustee_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.to_modif_bouteille:
                ...
                Intent intent = new Intent(AfficherBouteilleDegusteeActivity.this, ModifierBouteilleActivity.class);
