...
/**
 * Created by Mat & Audrey on 11/03/2018.
 */

public class StoragePermissions extends AppCompatActivity {

    /***************************************************/
    /* permissions for writing external storage*/
    /***************************************************/

    protected static final int MY_PERMISSIONS_REQUEST_WRITE_EXTERNAL_STORAGE = 1;

    protected int GrantPermissionsForWriting(){
